        ...
        if (inSplineNodeSelectionCount == 1)
        {
            if (Selection.objects.Length == 1)
            {
                ...
                if (SplineNode.SplineController != null && Selection.activeGameObject != null)
                {
                    ...
                    Handles.CubeHandleCap(0, Selection.activeGameObject.transform.position, Quaternion.identity, 1.2f * 0.3f, EventType.Layout);
                    ...
                    for (int i = 0; i < SplineNode.SplineController.Nodes.Count; i++)
                    {
                        ...
                        {
                            Handles.CubeHandleCap(0, node.gameObject.transform.position, Quaternion.identity, 1.2f * 0.3f, EventType.Layout);
                        }
                    }
        ...
        else if(inSplineNodeSelectionCount == Selection.objects.Length)
        {
            if (Selection.activeGameObject != SplineNode.gameObject)
            {
                ...
                if(Selection.activeGameObject != null)
                    Handles.CubeHandleCap(0, Selection.activeGameObject.transform.position, Quaternion.identity, 0.2f, EventType.Layout);
                Selection.gameObjects.ForEach(go =>
                {
                    var node = go.GetComponent<InSplineNode>();
                    if(node != null)
                        Handles.CubeHandleCap(0, node.gameObject.transform.position, Quaternion.identity, 0.2f, EventType.Layout);
